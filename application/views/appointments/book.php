...
<body>
    ...
    background-color: #32afb5;">
                ...
                <!-- try new moal -->
                <button id="myBtn_skycleaner">SOS button</button>

                <!-- The Modal -->
                <div id="myModal_skycleaner" class="modal_sky">

                <!-- Modal content -->
                <div class="modal-content_sky">
                    <span class="close_modal_sky">&times;</span>
                ...
                <script>
                // Get the modal
                var modal_sky = document.getElementById("myModal_skycleaner");

                // Get the button that opens the modal
                var btn = document.getElementById("myBtn_skycleaner");

                // Get the <span> element that closes the modal
                var span = document.getElementsByClassName("close_modal_sky")[0];

                // When the user clicks on the button, open the modal
                btn.onclick = function() {
                modal_sky.style.display = "block";
                }

                // When the user clicks on <span> (x), close the modal
                span.onclick = function() {
                modal_sky.style.display = "none";
                }

                // When the user clicks anywhere outside of the modal, close it
                window.onclick = function(event) {
                if (event.target == modal_sky) {
                    modal_sky.style.display = "none";
                }
                }
